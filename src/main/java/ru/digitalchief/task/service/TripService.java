...
public class TripService {
    ...
    @Transactional
    public TripFullDataResponse save(@NotNull TripRequest tripRequest) {
        ...
        return mapper.mapTripToTripFullDataResponse(tripToSave);
    }
    ...
    @Transactional
    public TripFullDataResponse update(@NotNull Long id,
        ...
        return mapper.mapTripToTripFullDataResponse(tripToUpdate);
    }
